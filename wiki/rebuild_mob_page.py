...
<head>
  ...
  <meta name="description" content="Look up mob details in Mine &amp; Dungeon \u2014 combat stats, loot drops and more. Powered by the official 23-Steps wiki." />
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .loot-rare-tag {
      font-size: 0.55em; font-weight: 700; padding: 2px 6px; border-radius: 3px;
      background: rgba(251,146,60,.15); border: 1px solid rgba(251,146,60,.3); color: #fb923c; margin-top: 2px;
    }
...
SCRIPT = '''  <script id="mob-data" type="application/json">''' + json_blob + '''</script>
  <script>
    /* Helpers */
...
output = HEAD + BODY_OPEN + SCRIPT
with io.open('mob.html', 'w', encoding='utf-8') as f:
    f.write(output)

print("Done! mob.html rebuilt with theme system.")
